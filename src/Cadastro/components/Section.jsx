    ...
    return(
        <div className='w-full h-[100vh] bg-Bitcoin bg-no-repeat bg-cover'>
            ...
            <div className='w-[35%] bg-gray-300 absolute left-[50%] top-[50%] -translate-x-1/2 -translate-y-1/2 backdrop-blur-sm bg-opacity-40 rounded-2xl  '>
                <h3 className='text-center font-semibold text-3xl p-5'>Realize seu Cadastro!</h3>
               ...
               <div className='mt-6'>
                    <h3 className='text-center font-semibold'>Ou cadastre-se com:</h3>
               </div>
                ...
                <div className=' flex flex-col justify-center items-center w-full mt-12 gap-7 '>
                    ...
                    <p className='font-medium pb-5 transition-all duration-300 hover:invert'>Já possui uma conta? <Link to='/login' className='text-white border-b-2 border-black transition-all duration-300 hover:invert'>Faça seu Login!</Link></p>
                </div>
