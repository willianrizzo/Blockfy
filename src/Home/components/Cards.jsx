        ...
        <div className=" w-[70%] m-auto mt-20 flex flex-col gap-20">
            <div className="bg-black bg-opacity-80 flex items-center gap-28 rounded-xl">
                <div className="w-[50%] p-10">
                    ...
                    <Link to='/cadastro' className='bg-[#FFAD0D] text-xl p-3 flex items-center w-[36%]  text-white mt-12 rounded-sm hover:bg-white hover:text-[#FFAD0D] transition-all duration-200'>Abra sua conta!</Link>
                </div>
            ...
            <div className="bg-black bg-opacity-80 flex items-center gap-48 rounded-xl">
                ...
                <div className="w-[45%] p-10 text-right ">
                    ...
                    <Link to='/cadastro' className='bg-[#FFAD0D] text-xl p-3 flex ml-[60%] w-[43%] text-white mt-12 rounded-sm hover:bg-white hover:text-[#FFAD0D] transition-all duration-200'>Peça seu cartão!</Link>
                </div>
            </div>
        </div>
    )
